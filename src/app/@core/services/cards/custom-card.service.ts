...
export class CustomCardsService {
    ...
    getImage(type: CardType, selected = false): Observable<string> {
        return this.store.select(SettingsSelectors.darkMode).pipe(map(darkMode => {
            if (selected) {
                if (type == 'MasterCard') {
                ...
                if (type == 'MasterCard') {
                    return darkMode ? '../../../../assets/img/master-card-white.svg' : '../../../../assets/img/master-card-color.svg'
                }
                if (type == 'Visa') {
                    return darkMode ? '../../../../assets/img/visa-card-white.svg' : '../../../../assets/img/visa-card-color.svg'
                }
                if (type == 'Prostir') {
                    return darkMode ? '../../../../assets/img/prostir-card-white.svg' : '../../../../assets/img/prostir-card-color.svg'
                }
            }
            return '';
        }))
