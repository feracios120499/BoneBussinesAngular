...
export namespace AcctActions {
  ...
  export const openRequisitesModal = createAction(
    '[ACCT] open requestis modal',
    props<{ account: AccountModel }>()
  );
  ...
  ] = createHTTPActions<DownloadRequisitesModel, FileModel, string>(
  ...
  ] = createHTTPActions<SendRequisitesModel, never | any, string>(
  ...
  ] = createHTTPActions<DonwloadExportModel, FileModel, string>(
    '[ACCT] download export turnovers'
  );
  ...
  ] = createHTTPActions<SendExportModel, never | any, string>(
