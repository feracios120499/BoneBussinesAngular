...
export class AcctEffects {
  ...
  setCurrencyFilterOther$ = createEffect(() =>
    this.actions$.pipe(
      ...
      filter((formControl: SetValueAction<boolean>) =>
        formControl.controlId.startsWith(ACCT_FILTER_FORM)
      ),
      withLatestFrom(this.store.select(AcctSelectors.form)),
      filter(
        ([formControl, form]: [
          SetValueAction<boolean>,
          FormGroupState<AcctFilter>
        ]) =>
          formControl.controlId === form.controls.currency.controls.OTHER.id &&
        ...
        const config: RequisitesModalConfig = {
          ...
          callback: (result) => {
            ...
            if (result.sendToEmail) {
              ...
              this.store.dispatch(
                AcctActions.downloadRequisitesRequest({ ...model })
              );
            }
          },
        };
        ...
        const config: ExportTurnoverModalConfig = {
          ...
          callback: (result) => {
            ...
            if (result.sendToEmail) {
              ...
              this.store.dispatch(
                AcctActions.downloadExportTurnoversRequest({ ...model })
              );
            }
          },
        };
      ...
      switchMap((payload) =>
        this.accountsService
          ...
          .pipe(
            ...
            catchError((error) =>
              of(AcctActions.downloadRequisitesFailure(error.error.Message))
            )
          )
      )
    )
      ...
      switchMap((payload) =>
        this.accountsService
          ...
          .pipe(
            ...
            catchError((error) =>
              of(AcctActions.sendRequisitesFailure(error.error.Message))
            )
          )
      )
    )
      ...
      switchMap((payload) =>
        this.accountsService
          ...
          .pipe(
            ...
            catchError((error) =>
              of(
                AcctActions.downloadExportTurnoversFailure(error.error.Message)
              )
            )
          )
      )
      ...
      switchMap((payload) =>
        this.accountsService
          ...
          .pipe(
            ...
            catchError((error) =>
              of(AcctActions.sendExportTurnoversFailure(error.error.Message))
            )
          )
      )
    )
      ...
      switchMap((payload) =>
        this.accountsService
          ...
          .pipe(
            ...
            catchError((error) =>
              of(AcctActions.downloadStatementFailure(error.message))
            )
          )
      )
    )
      ...
      switchMap((payload) =>
        this.accountsService
          ...
          .pipe(
            ...
            catchError((error) =>
              of(AcctActions.sendStatementFailure(error.message))
            )
          )
      )
    )
