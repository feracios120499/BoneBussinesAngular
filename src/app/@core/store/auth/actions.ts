...
export namespace AuthActions {
    ...
    export const [
        loadCryptorTokens,
        loadCryptorTokensSuccess,
        loadCryptorTokensFailure] = createHTTPActions<void, CryptorToken[], string>('[AUTH] load cryptor tokens');
    ...
    export const [
        loadCryptorKeys,
        loadCryptorKeysSuccess,
        loadCryptorKeysFailure
    ] = createHTTPActions<CryptorToken, CryptorKey[], string>('[AUTH] load cryptor keys');
    ...
    export const [
        ...
        loginCryptorSuccess,
        loginCryptorFailure
    ] = createHTTPActions<{ key: CryptorKey, token: CryptorToken }, Token, string>('[AUTH] login cryptor');
}
