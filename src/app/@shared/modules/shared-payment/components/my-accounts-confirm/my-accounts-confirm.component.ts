...
@Component({
  selector: 'pay-my-accounts-confirm',
  templateUrl: './my-accounts-confirm.component.html',
  styleUrls: ['./my-accounts-confirm.component.scss']
})
export class MyAccountsConfirmComponent implements OnInit {
  ...
  save(payment: PaymentForm): void {
    ...
    this.store.dispatch(PayFormsActions.createMyAccountsRequest({
      ...payment,
