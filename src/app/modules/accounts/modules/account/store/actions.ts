...
export namespace AcctDetailsActions {
  ...
  export const [loadAccount, loadAccountSuccess, loadAccountFailure] = createHTTPActions<
    { accountId: number; bankId: string },
    AccountModel,
    string
  >('[ACCT] load account');

  export const setCurrentAccount = createAction('[ACCT] set current account', props<{ account: AccountModel }>());

  // setAccountName action
  export const setAccountName = createAction('[ACCT] set account name', props<{ name: string }>());
  ...
  export const [updateAccountRequest, updateAccountSuccess, updateAccountFailure] = createHTTPActions<
    AcctEdit,
    AccountModel,
    string
  >('[ACCT] update account');

  export const updateRangeTransactions = createAction('[ACCT] update range', props<{ start: Dayjs; end: Dayjs }>());

  export const loadTurnoversCurrentAccount = createAction('[ACCT] load turnovers current account');

  export const [loadTurnoversRequest, loadTurnoversSuccess, loadTurnoversFailure] = createHTTPActions<
  ...
  export const openTurnovers = createAction('[ACCT][Details] open turnovers', props<{ id: string }>());

  export const closeTurnovers = createAction('[ACCT][Details] close turnovers', props<{ id: string }>());
